    ...
    },
    {
      ...
      render: (_, line) => (
        <InputNumber
          ...
          onChange={(value) => onQtyChange(line.product.productId ?? line.product.id, value || 1)}
        />
      ),
    },
    {
    ...
    },
    {
      ...
      render: (_, line) => (
        <Button
          ...
          icon={<DeleteOutlined />}
          onClick={() => onRemove(line.product.productId ?? line.product.id)}
        />
      ),
    },
  ];
  ...
  return (
    <div className={styles.cartTableWrap}>
      <Table
        ...
        columns={columns}
        dataSource={lines}
        rowKey={(line) => line.product.productId ?? line.product.id}
        pagination={false}
      />
    </div>
  );
